...
SearchTextField supports two different modes: the classic dropdown list (by default) and the inline mode perfect for autocomplete email domains as an example.
  ...
  s.homepage         = "https://github.com/softshopNoOficial/SearchTextField"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Alejandro Ferreira" => "aferreira@softshop.com.py" }
  s.source           = { :git => "https://github.com/softshopNoOficial/SearchTextField.git", :tag => s.version.to_s }
